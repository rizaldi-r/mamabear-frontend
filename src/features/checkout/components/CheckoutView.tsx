...
export function CheckoutView({
  ...
  // STEP 3: Payment Confirmation View matching image_a6a2e3.png
  if (isOrderCreated) {
    return (
        ...
        <div className="max-w-xl mx-auto text-center py-16 space-y-8">
          <div className="space-y-4">
            <h2 className="text-font-4 font-bold text-[var(--mama-brown)]">
              Pesanan Mama belum dibayar
            </h2>
            <p className="text-font-2 text-gray-500 leading-relaxed max-w-sm mx-auto">
              Segera bayar pesanan Mama sebelum dibatalkan otomatis oleh sistem.
            </p>
          </div>
          ...
          <div>
            <a
              ...
              className="inline-block bg-[var(--mama-hot-pink)] hover:bg-[#c24467] text-white font-bold py-4 px-12 rounded-full transition-colors text-font-3 shadow-sm uppercase min-w-[280px]"
            >
              Bayar Pesanan
            </a>
          </div>
