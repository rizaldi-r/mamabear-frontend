...
function ImageGallery({ images }: Props) {
  const [img] = useState<Image[]>(images);
    ...
    <div className=" w-full relative">
      ...
      <div className="flex justify-between w-full top-[15rem] absolute items-center">
        ...
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="size-7 bg-white cursor-pointer"
          onClick={() =>
        ...
        <>
          ...
          >
            <Image
              unoptimized
              alt=""
              className="w-[35%] cursor-zoom-in transition-transform duration-300 hover:scale-150"
              src={img[imgIndex].imageUrl}
            />
          </div>
        </>
