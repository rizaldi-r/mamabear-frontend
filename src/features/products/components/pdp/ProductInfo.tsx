  ...
  return (
    <div className='w-full flex flex-col gap-4'>
      ...
      <div className='flex gap-5 items-center'>
        ...
        <p className='text-gray-500 text-font-4 line-through'>Rp {parseInt(selectedVariant.priceIdr).toLocaleString("id-ID")}</p>
      </div>
    ...
    {variants.length > 0 &&
      ...
      <div className='flex gap-2'>
        <button onClick={()=>submitProduct()} className='w-[90%] bg-[var(--mama-hot-pink)] text-font-4 rounded-4xl font-bold text-white flex items-center justify-center'>
