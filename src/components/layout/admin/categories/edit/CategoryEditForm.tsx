...
import { CategoryFormValues } from "../new/type";
import { BasicInfoSection } from "../new/BasicInfoSection";
import ImageUploadSection from "../new/ImageUploadSection";
import { SeoSection } from "../new/SeoSection";
...
const useCategoryEditForm = (initialData: Category) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      imageUrl : initialData.images?.[initialData.images.length - 1]?.imageUrl || ''
    },
  });
    ...
    <div className="w-full flex flex-col gap-6">
      ...
      >
        ...
        <div className="p-6 flex flex-col gap-8">
          ...
          <SeoSection register={register} isSubmitting={isSubmitting} control={control}/>
        </div>
